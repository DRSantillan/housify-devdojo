...
const EditListing = () => {
	...
	// redirect if user doesnt nown listing
	useEffect(() => {
	...
	const onSubmitEditListing = async event => {
		...
		if (discountedPrice >= regularPrice) {
			setLoading(false);
			toast.error(
				'Discounted price needs to be less than the Regular listing Price.'
			);
			return;
		}
		if (images.length > 6) {
		...
		setLoading(false);
		toast.success('Your listing has been added and ready for sale.');
	...
	return (
		<div className='profile'>
			...
			<main>
				<form onSubmit={onSubmitEditListing}>
